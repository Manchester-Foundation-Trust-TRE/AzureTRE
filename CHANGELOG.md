...
* Ensure Service Bus async clients are properly closed in API status updaters to prevent unclosed client session errors ([#1462](https://github.com/microsoft/AzureTRE/issues/1462)).
