...
* Ensure Service Bus async clients are properly closed in API status updaters to prevent unclosed client session errors ([#0000](https://github.com/microsoft/AzureTRE/issues/0000)).
