...
* UI: Migrated from Vite to Next.js for improved performance and modern development experience

ENHANCEMENTS:
* UI: Migrate web UI from Vite to Next.js with static export for Azure Storage deployment
